export default {
    ...
    // m
    'MBC': ['imnews.imbc.com/*'],
    'MBN': ['mbn.mk.co.kr/pages/news/newsView.php*', 'www.mbn.co.kr/pages/news/newsView.php*'],
    // o
    'OSEN': ['osen.mt.co.kr/article/*'],
    // s
    'SBS': ['news.sbs.co.kr/news/endPage.do*'],
    // y
    ...
    '미디어오늘': ['www.mediatoday.co.kr/news/articleView.html*'],
    '민중의소리': ['www.vop.co.kr/A*.html'],
    // ㅂ
    ...
    '아이뉴스24': ['news.inews24.com/php/news_view.php*', 'joynews.inews24.com/php/news_view.php*'],
    '여성뉴스': ['www.womennews.co.kr/news/*'],
    '연합뉴스': ['www.yonhapnews.co.kr/*AKR*.HTML*'],
    '오마이뉴스': ['www.ohmynews.com/NWS_Web/View/at_pg.aspx*'],
    '월스트리트저널': ['kr.wsj.com/posts/*', 'realtime.wsj.com/korea/*'],
    '이데일리': ['www.edaily.co.kr/news/NewsRead.edy*', 'starin.edaily.co.kr/news/NewsRead.edy*'],
    '일간스포츠': ['isplus.joins.com/article/*', 'isplus.live.joins.com/news/article/article.asp*'],
    // ㅈ
    '전자신문': ['www.etnews.com/*'],
    ...
    '코리아헤럴드': ['www.koreaherald.com/view.php*', 'khnews.kheraldm.com/view.php*'],
    // ㅍ
    '파이낸셜뉴스': ['www.fnnews.com/news/*'],
    '프레시안': ['www.pressian.com/news/article.html*'],
    // ㅎ
    '한겨레': ['hani.co.kr/arti/*', 'www.hani.co.kr/arti/*'],
    '한국경제': ['www.hankyung.com/news/app/newsview.php*', 'ent.hankyung.com/news/app/newsview.php*', 'golf.hankyung.com/news/app/newsview.php*', 'land.hankyung.com/news/app/newsview.php*'],
    '한국경제증권': ['stock.hankyung.com/news/app/newsview.php*'],
    '한국경제TV': ['www.wowtv.co.kr/newscenter/news/view.asp*'],
    '한국일보': ['www.hankookilbo.com/v/*', 'hankookilbo.com/v/*'],
    '허핑턴포스트': ['www.huffingtonpost.kr/*'],
    '헤럴드경제': ['biz.heraldcorp.com/view.php?*', 'news.heraldcorp.com/view.php?*'],
};
