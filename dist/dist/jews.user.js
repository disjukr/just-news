...
// @include http://news.kbs.co.kr/news/view.do?*
...
// @include http://sports.donga.com/*/3/*
// @include http://www.sportsseoul.com/news/read/*
// @include http://sports.chosun.com/news/ntype.htm*
...
// @include http://news.joins.com/article/*
...
___scope___.file("jews.user.js", function(exports, require, module, __filename, __dirname){ 

'use strict';

exports.__esModule = true;
exports.Jews = undefined;
exports.waitWhilePageIsLoading = waitWhilePageIsLoading;
exports.checkUrl = checkUrl;
exports.here = here;
exports.jewsable = jewsable;
exports.default = jews;
...
var _reconstruct = require('./reconstruct');

var _reconstruct2 = _interopRequireDefault(_reconstruct);
...
class Jews {
    constructor() {
        ...
        this._timestamp = {
            ...
            get created() {
                if (this._created instanceof Date) return new Date(this._created);
                return this._created;
            },
            set created(v) {
                if (typeof v === 'number' || v instanceof Number || typeof v === 'string' || v instanceof String) {
            ...
            get lastModified() {
                if (this._lastModified instanceof Date) return new Date(this._lastModified);
...
function waitWhilePageIsLoading() {
    return new Promise(resolve => {
        switch (document.readyState) {
            case 'interactive':case 'complete':
                {
                    resolve();break;
                }
            default:
...
function jews() {
    var where = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : here();
        ...
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return waitWhilePageIsLoading();

                case 3:
                    _context.t0 = _reconstruct2.default;
                    _context.next = 6;
                    return jews();
                ...
                case 10:
                    ...
                    err = _context.t2 ? _context.t2.stack || _context.t2 : _context.t2;
...
exports.default = function () {
    return new Promise(resolve => {
        var t = document.getElementsByClassName('news_list_time')[0].textContent.trim(),
            ...
            d = 1000 * 60 * 60 * 24;
        function f(m) {
            return new Date(((Date.now() / d | 0) - (m | 0)) * d - 1000 * 60 * 60 * 9 /* +09:00 */);
        }
        if (date !== null) t = new Date(date[1] + '-' + date[2] + '-' + date[3] + 'T00:00:00+09:00');else {
            if (m === null) if ((m = /(\d+)시간 전/.exec(t)) !== null) d /= 24;else if ((m = /(\d+)분 전/.exec(t)) !== null) d /= 24 * 60;
            if (m !== null) t = f(m[1]);
        }
        var j = {
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#articlebody .article_content')[0].cloneNode(true);
        (0, _jquery2.default)('.article_msn_ad, #id_movie_area, .article_list, .regard_area', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.artical_date').children();
        var lastModified;
    ...
    jews.reporters = function () {
        var result = [];
        var textReporter = (0, _jquery2.default)('#textReporter_area dl');
        var cameraReporter = (0, _jquery2.default)('#cameraReporter_area dl');
        var editReporter = (0, _jquery2.default)('#editReporter_area dl');
        [textReporter, cameraReporter, editReporter].forEach(function (v) {
            if (v.length > 0) {
                result.push({
                    name: (0, _jquery2.default)('.name', v).contents().eq(0).text().trim(),
                    mail: (0, _jquery2.default)('.sns a[href^="mailto:"]', v).eq(0).attr('href').replace('mailto:', '')
                });
            }
        });
        return result;
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        if (photo !== undefined) content.insertBefore(photo.getElementsByTagName('img')[0], content.firstChild);
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
...
exports.default = function () {
    ...
    jews.reporters = [{
        name: (0, _jquery2.default)('.sec_subject .source').text()
    }];
    return jews;
};
...
exports.default = function () {
    ...
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#DivPrint .article-time-date').text().replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = [{
        name: (0, _jquery2.default)('#DivPrint .reporter').text().trim().split(/\s+/)[0],
        mail: undefined
    }];
    return jews;
};
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#newsViewArea')[0].cloneNode(true);
        (0, _jquery2.default)('*[id*=google]', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#article_title .reg_dt').text().replace(/[가-힣]/g, '').replace(/\s+(\d\d:\d\d)/g, 'T$1:00+09:00').trim()),
        lastModified: function () {
            var tmp = new Date((0, _jquery2.default)('#article_title .upd_dt').text().replace(/-/g, '/'));
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#_article')[0].cloneNode(true);
        (0, _jquery2.default)('iframe, #divBox, #scrollDiv, div[class^=tabArea], .mask_div, .articleList', content).remove();
        (0, _jquery2.default)('a', content).each(function (_, anchor) {
            (0, _jquery2.default)(anchor).replaceWith((0, _jquery2.default)(anchor)[0].innerHTML);
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date(/\d{4}.\d\d.\d\d\s+\d\d:\d\d/.exec((0, _jquery2.default)('#container .writer').text())[0].replace(/\./g, '/')),
        lastModified: undefined
    };
    jews.reporters = function () {
        var mail = (0, _jquery2.default)('#container .detailLink a[href^=mailto]');
        if (mail.length > 0) mail = mail.attr('href').substr('mailto:'.length);
        return [{
            name: (0, _jquery2.default)('#container .writer').text().split(/\s+/)[1],
            mail: mail || undefined
        }];
    }();
    return jews;
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#container .smdend_content_w .sep_cont_w .sed_article_w .sed_article')[0].cloneNode(true);
        (0, _jquery2.default)('.lazy', content).each(function (_, anchor) {
    ...
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('#container .smdend_content_w .sep_cont_w .sed_atcinfo_sec_w .sed_write_time').contents();
    ...
    jews.reporters = function () {
        var parsedData = (0, _jquery2.default)('#container .smdend_content_w .sep_cont_w .seda_author').children();
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        (0, _jquery2.default)('.share_btns', content).remove();
        (0, _jquery2.default)('.copyright', content).remove();
        (0, _jquery2.default)('div:last-child', content).remove();
        (0, _jquery2.default)('div[id^=float]', content).remove();
        (0, _jquery2.default)('#iwm_float', content).remove();

        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.article_info .extra_info').text().trim().replace('Posted : ', '').replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv, #content style').remove();
        (0, _jquery2.default)('.dklink').each(function (_, link) {
            (0, _jquery2.default)(link).replaceWith((0, _jquery2.default)(link).text());
        });
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#sub_cntTopTxt')[0].cloneNode(true);
        (0, _jquery2.default)('a', content).each(function (_, anchor) {
            (0, _jquery2.default)(anchor).replaceWith((0, _jquery2.default)(anchor)[0].innerHTML);
        });
        (0, _jquery2.default)('#article_bottom_ad, #divBox', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var times = (0, _jquery2.default)('.time').text().split('\u3163'); // Korean vowel 'ㅣ'
        return {
    ...
    jews.reporters = function () {
        var information = (0, _jquery2.default)('.info_part').text().match(/(.*)\s+(.*@.*)/);
        if (information !== null) {
            return [{
            ...
            return [{
                name: (0, _jquery2.default)('.info_part').text().trim(),
                mail: undefined
            }];
        }
    }();
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('.art_body')[0].cloneNode(true);
        (0, _jquery2.default)('a', content).each(function (_, anchor) {
            (0, _jquery2.default)(anchor).replaceWith((0, _jquery2.default)(anchor)[0].innerHTML);
        });
        (0, _jquery2.default)('#article_bottom_ad, #divBox', content).remove();
    ...
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.art_header .byline').contents();
        return {
    ...
    jews.reporters = function () {
        var parsedData = (0, _jquery2.default)('.subject .name').text().trim().split(/\s+/);
        return [{
            name: parsedData[0],
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _util.clearStyles)((0, _jquery2.default)('#articleBody')[0].cloneNode(true));
        var fbPost = (0, _jquery2.default)('#articleBody .fb-post');
        if (fbPost.length > 0) {
            (0, _jquery2.default)('.fb-post', content).replaceWith(fbPost[0].outerHTML);
        }
    ...
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.NwsCon .nwsti .date .t11');
        return {
    ...
    jews.reporters = function () {
        var name = (0, _jquery2.default)('.NwsCon .nwsti .nm').text().trim();
        var match = (0, _jquery2.default)('#articleBody').text().match(new RegExp(name + '\\s+([^\\s]+@[^\\s]+)'));
        return [{
            name: name,
    ...
    jews.cleanup = function () {
        ...
        (0, _jquery2.default)('#wp_adbn_root').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#articleContent')[0].cloneNode(true);
        (0, _jquery2.default)('#hnsIframe, #ifrm_photolink, table[width="250px"][height="250px"]', content).remove();
        var figure = (0, _jquery2.default)('table[align="center"]', content)[0];
        if (figure) {
            (0, _jquery2.default)('table div', figure).each(function (i, el) {
                (0, _jquery2.default)(el).replaceWith((0, _jquery2.default)('ul li', (0, _jquery2.default)(el))[0].innerHTML);
            });
        }
        (0, _jquery2.default)('a.dklink', content).each(function (i, el) {
            (0, _jquery2.default)(el).replaceWith(el.textContent);
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.atic_title .tdata').text().split('\u3163'); // Korean vowel 'ㅣ'
        return {
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#pnlContent')[0].cloneNode(true);
        (0, _jquery2.default)('.relatednews', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.reporter_info ul li:first-child span').text().replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = [{
        name: (0, _jquery2.default)('.reporter_info .email span').text(),
        mail: (0, _jquery2.default)('.reporter_info .email a').attr('title')
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv').remove();
    };
...
exports.default = function () {
    ...
    jews.subtitle = function () {
        var h3 = (0, _jquery2.default)('h3', titleData).text();
        var h2 = (0, _jquery2.default)('h2', titleData).text();
        if (h3) {
            return h3 + '<br>' + h2;
        } else {
            return h3;
    ...
    var content = (0, _jquery2.default)('#ndArtBody')[0].cloneNode(true);
    (0, _jquery2.default)('#writerProfileCon ~ div', content).remove();
    (0, _jquery2.default)('#writerProfileCon', content).remove();
    jews.content = (0, _util.clearStyles)(content).innerHTML;

    jews.timestamp = {
        created: undefined,
        lastModified: new Date((0, _jquery2.default)('.writeInfo').text().split('최종편집 ')[1].trim().replace(/\./g, '-').replace(' ', 'T') + '+09:00') // ISO 8601
    };
    console.log((0, _jquery2.default)('.writeInfo').text().split('최종편집 ')[1].trim().replace(/\./g, '-').replace(' ', 'T') + '+09:00');
    var reporter = (0, _jquery2.default)('#writerProfileCon');
    jews.reporters = [{
        name: (0, _jquery2.default)('.filetxt.mt12', reporter).text(),
        mail: (0, _jquery2.default)('.filetxtmail', reporter).text()
    }];
    return jews;
};
...
exports.default = function () {
    ...
    jews.subtitle = function () {
        var h3 = (0, _jquery2.default)('h3', headline).text();
        var p_toptitle = (0, _jquery2.default)('p.toptitle', headline).text();
    ...
    jews.reporters = [{
        'name': (0, _jquery2.default)('.cnt_view.news_body_area > div:eq(-2) ul a li').text(),
        'mail': undefined
    }];
    console.log((0, _jquery2.default)('.arvdate').text().split(/최종편집\s+/));
    jews.timestamp = {
        'created': undefined,
        'lastModified': new Date((0, _jquery2.default)('.arvdate').text().split(/최종편집\s+/)[1].replace(/\./g, '-').replace(/\s+/, 'T') + '+09:00') // ISO 8601
    };
    (0, _jquery2.default)('>div:last-child', content).remove();
    jews.content = (0, _util.clearStyles)(content).innerHTML;
    return jews;
...
exports.default = function () {
    ...
    jews.title = (0, _jquery2.default)('h2', headline).text();
    jews.subtitle = (0, _jquery2.default)('h3', headline).text().replace(/\n/g, '<br>');
    jews.content = function () {
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        return {
            created: new Date((0, _jquery2.default)('div.info', headline).text().split('|')[1].replace(' 송고', '').replace(/\./g, '/').replace(' ', 'T').replace(/\s+/g, '') + '+0900'),
            lastModified: undefined
        };
    }();
    jews.reporters = function () {
        var reporters = (0, _jquery2.default)('div.info', headline).text().split('|')[0].replace(/\(.+?\)/, '').split(', ');
        var result = [];
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#articleBody')[0].cloneNode(true);
        var centerImage = (0, _jquery2.default)('.center_img')[0];
        // $('.relatednews', content).remove();
        if (centerImage) {
            return (0, _util.clearStyles)(centerImage.cloneNode(true)).innerHTML + (0, _util.clearStyles)(content).innerHTML;
        }
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var $time = (0, _jquery2.default)('font', (0, _jquery2.default)('.viewnewstitle').closest('tbody'));
        return {
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)((0, _jquery2.default)('#view_con')[0].cloneNode(true));
        (0, _jquery2.default)('a.dklink', content).each(function (i, el) {
            (0, _jquery2.default)(el).replaceWith(el.textContent);
        });
        (0, _jquery2.default)('.contents_img', content).each(function (i, el) {
            el.removeAttribute('width');
        });
        return (0, _util.clearStyles)(content[0]).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#view_titlebox2_3 span').text().replace('등록 : ', '').replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = function () {
        var parsedData = (0, _jquery2.default)('#view_page .view_title_sub').eq(0).contents()[0].textContent.trim();
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#GS_Content')[0].cloneNode(true);
        (0, _jquery2.default)('#frm_AD_GISA_PHOTO_LINE, #AD_GISA_PHOTO_LINE', content).remove();
        (0, _jquery2.default)('a', content).each(function (_, anchor) {
            (0, _jquery2.default)(anchor).replaceWith((0, _jquery2.default)(anchor)[0].innerHTML);
        });
        var photo = (0, _jquery2.default)('#GS_RelPhoto')[0];
        if (photo) {
            var photoDiv = document.createElement('div');
            photo = photo.cloneNode(true);
            if ((0, _jquery2.default)('.RelPhoto2', photo)[0]) (0, _jquery2.default)('.RelPhoto1', photo).remove();
            (0, _jquery2.default)('li > *', photo).toArray().forEach(function (item) {
                photoDiv.appendChild((0, _util.clearStyles)(item));
            });
            return (0, _util.clearStyles)(photoDiv).innerHTML + (0, _util.clearStyles)(content).innerHTML;
        }
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#input_time dd').eq(0).text().replace('입력시간 :', '').trim()),
        lastModified: new Date((0, _jquery2.default)('#modify_gisa').eq(0).text().replace('수정시간 :', '').replace(/\./g, '/').trim())
    };
    jews.reporters = (0, _jquery2.default)('#GS_Reporter ul li').toArray().map(function (li) {
        li = li.cloneNode(true);
        var mail = (0, _jquery2.default)('a', li).text();
        (0, _jquery2.default)('a', li).remove();
        var name = (0, _jquery2.default)(li).text();
        return { name: name, mail: mail };
    });
    jews.cleanup = function () {
        (0, _jquery2.default)('#frm_photoLink').remove();
        (0, _jquery2.default)('#scrollDiv').remove();
    };
    return jews;
};
...
exports.default = function () {
    var jews = {};
    jews.title = (0, _jquery2.default)('.article_title02 h1').text();
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('.article_txt')[0].cloneNode(true);
        (0, _jquery2.default)('.title_foot', content).remove();
        (0, _jquery2.default)('.txt_ad, [class^=sub_cont_AD]', content).remove();
        (0, _jquery2.default)('.recommend', content).remove();
        (0, _jquery2.default)('.article_relation', content).remove();
        (0, _jquery2.default)('.t_sns', content).remove();
        (0, _jquery2.default)('[alt="기자의 다른기사 더보기"]', content).parent().remove();
        (0, _jquery2.default)('.cha_link', content).each(function () {
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        (0, _jquery2.default)('.txtBox', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#NewsAdContent')[0].cloneNode(true);
        (0, _jquery2.default)('a', content).each(function (_, anchor) {
            (0, _jquery2.default)(anchor).replaceWith((0, _jquery2.default)(anchor)[0].innerHTML);
        });
        (0, _jquery2.default)('[alt="DT Main"]', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = /입력: (....-..-.. ..:..)/.exec((0, _jquery2.default)('#news_names p').text());
        return {
    ...
    jews.reporters = [{
        name: (0, _jquery2.default)('#news_names p')[0].childNodes[0].textContent.trim(),
        mail: (0, _jquery2.default)('#news_names p [href^=mailto]').text()
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#soeaLayerLoc_fi').remove();
    };
    return jews;
};
...
exports.default = function () {
    return new Promise(resolve => {
        ...
        jews.content = function () {
            var header = '';
            var articleImage = (0, _jquery2.default)('#articleImage')[0];
            if (articleImage) {
                header += (0, _util.clearStyles)(articleImage.cloneNode(true)).innerHTML;
            }
            return header + (0, _util.clearStyles)((0, _jquery2.default)('#articleText')[0].cloneNode(true)).innerHTML;
        }();
        jews.timestamp = {
            created: new Date((0, _jquery2.default)('.article-header .timestamp').text().trim().replace(/\s+/g, " ").replace(/^([A-Z][a-z]{2}) ([A-Z][a-z]{2}) (\d+),/, "$1, $3 $2").replace(/(\d+)(:\d+)([ap]m)/, function (_, a, b, c) {
                a |= 0;
                if (c === "pm") a += 12;
                if (a % 12 === 0) a -= 12;
                return a + b + ":00";
        ...
        jews.reporters = function () {
            var result = [];
            var rawReporters = (0, _jquery2.default)('#articleInfo .byline').text().replace(/By /, '');
            if (rawReporters !== "") {
                // Reporters exist.
        ...
        jews.cleanup = function () {
            (0, _jquery2.default)('#trackbar, iframe').remove();
        };
        if ((0, _jquery2.default)('#slideshowInlineLarge+script')[0]) {
            var xhr = new XMLHttpRequest();
            xhr.open('GET', (0, _jquery2.default)('#slideshowInlineLarge+script')[0].textContent.split(/'sJSON'|"sJSON"/g).pop().match(/\/assets\/[^']+/), true);
            xhr.onreadystatechange = function () {
                if (this.readyState === (this.DONE || 4)) {
                    var r = this.responseText;
                    var imgJSON = new Function('return ' + r.substring(r.indexOf('{'), r.lastIndexOf('}') + 1))();
...
exports.default = function () {
    ...
    jews.timestamp = {
        created: new Date(('20' + (0, _jquery2.default)('.read_view_date').text()).replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = [];
    jews.cleanup = function () {
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        (0, _jquery2.default)('img[alt="사진설명"]', d).remove();
        (0, _jquery2.default)('script', d).remove();
    ...
    }();
    {
        ...
        jews.reporters = [{ name: (0, _jquery2.default)('.author', $a).text() }];
    }
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#textBody')[0].cloneNode(true);
        (0, _jquery2.default)('#now-sence', content).remove();
        (0, _jquery2.default)('span.up, span.down', content).remove();
        (0, _jquery2.default)('a', content).each(function (v) {
            if ((0, _jquery2.default)('img', v)[0]) return;
            (0, _jquery2.default)(v).replaceWith(v.textContent);
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.infobox1 .num:first').text().replace(": ", "").replace(/\./g, '/')), // ": 2014.06.20 06:31"형태로 들어있음
        lastModified: undefined
    };
    jews.reporters = function () {
        var ret = [];
        (0, _jquery2.default)('.infobox1 a').each(function () {
            var reporter = {
                name: (0, _jquery2.default)(this).text().replace(/ 기자$/, ''),
                mail: undefined
            };
            ret.push(reporter);
        });
        var main_reporter_name = (0, _jquery2.default)('.conbox strong').text();
        var main_reporter_mail = (0, _jquery2.default)('.conbox .mail').text();
    ...
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv').remove();
        (0, _jquery2.default)('.util_box').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#NewsAdContent')[0].cloneNode(true);
        (0, _jquery2.default)('.article_msn_ad', content).remove();
        var figure = (0, _jquery2.default)('table[align=center]', (0, _jquery2.default)('#view_body').prev())[0];
        if (figure) {
            figure = figure.cloneNode(true);
            figure = (0, _util.clearStyles)(figure).innerHTML;
        } else {
            figure = '';
        }
        return figure + (0, _util.clearStyles)(content).innerHTML;
    }();
    var created = /게재 일자 :(.+?)년(.+?)월(.+?)일/.exec((0, _jquery2.default)('td', (0, _jquery2.default)('.title').closest('table').prev().prev()).eq(1).text());
    created.shift();
    jews.timestamp = {
        created: new Date(created.map(function (d) {
            return +d;
        }).join('/')),
        lastModified: undefined
    };
...
exports.default = function () {
    ...
    var _filter = function _filter(a) {
        return [].filter.apply(a, [].slice.call(arguments, 1));
    };
    var el_filter = function el_filter(el, obj, m) {
        if (typeof el === "string") el = (0, _jquery2.default)(el)[0].childNodes;else if (el instanceof Node) el = el.childNodes;
        var f;
        if (m === true || m === undefined) f = function f(v) {
    ...
    jews.title = (0, _jquery2.default)('.View_Title>strong').text();
    jews.subtitle = (0, _jquery2.default)('.View_Title>span').text();
    jews.timestamp = {
        created: new Date(el_filter('.View_Time', HTMLElement, false)[0].textContent.trim().replace(/(\d{4})\.(\d{2})\.(\d{2})\s*/, "$1-$2-$3T") + "+09:00"),
        lastModified: undefined
    };
    var info = (0, _jquery2.default)('.View_Info')[0].childNodes;
    jews.reporters = [{
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#media_body')[0].cloneNode(true);
        (0, _jquery2.default)('.ad_lumieyes_area', content).each(function (i, el) {
            (0, _jquery2.default)(el).closest('tr').remove();
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var data = {};
        (0, _jquery2.default)('td[align="left"] table td', (0, _jquery2.default)('#font_email').closest('table').closest('td').closest('table')).text().split(/(입력|노출)\s*:([\d\-\.\s:]+)/).forEach(function (v, i, arr) {
            if (v === '입력') data.created = new Date(arr[i + 1].trim().replace(/\s+/g, ' ').replace(/[-\.]/g, '/') + '+0900');else if (v === '노출') data.lastModified = new Date(arr[i + 1].trim().replace(/\s+/g, ' ').replace(/[-\.]/g, '/') + '+0900');
        });
        return data;
    }();
    jews.reporters = function () {
        var parsedData = (0, _jquery2.default)('#font_email').text().split('|');
        return [{
...
exports.default = function () {
    ...
    jews.content = function () {
        var newsContent = (0, _jquery2.default)('#ArticleVContent')[0].cloneNode(true);
        (0, _jquery2.default)('#ArticleVAdvert', newsContent).remove();
        return (0, _util.clearStyles)(newsContent).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#ArticleVDate').text().trim().replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = function () {
        var reporters = (0, _jquery2.default)('#ArticleVName')[0].cloneNode(true);
        (0, _jquery2.default)('.goTop', reporters).remove();
        return [{
            name: (0, _util.clearStyles)(reporters).innerHTML,
            mail: undefined
        }];
    }();
    return jews;
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('.pf-content')[0].cloneNode(true);
        (0, _jquery2.default)('.printfriendly', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
    ...
    var $author = (0, _jquery2.default)('[itemprop="author"] a');
    jews.reporters = [{
        name: $author.text(),
        mail: $author.attr('href')
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#move-to-top, #selectionSharerPopover, #selectionSharerPopunder, #fb-root').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        (0, _jquery2.default)('#hnsIframe, #ifrm_photolink, #googleAdTable', content).remove();
        (0, _jquery2.default)('.dklink', content).each(function (i, v) {
            (0, _jquery2.default)(v).replaceWith(v.innerHTML);
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
...
exports.default = function () {
    ...
    document.getElementById('SG_ArticleDateLine').textContent.replace(/(입력|수정)\s*(\d{4}-\d{2}-\d{2})\s*(\d{2}:\d{2}:\d{2})/g, function (_, p1, p2, p3) {
    ...
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv, #realclick_view, script, iframe, .mask_div').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = (0, _util.clearStyles)(document.querySelector('#ct>div.article_word')).innerHTML;
    jews.reporters = [];
    jews.cleanup = function () {
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('.article')[0].cloneNode(true);
        (0, _jquery2.default)('span[style="margin-top:30px; float:right;padding-right:1px;margin-left:5px;display:inline;z-index:1;"]', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var time_info = (0, _jquery2.default)('.dateWrap li .date');
        return {
            // ISO 8601
    ...
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('span, iframe, #wp_adbn_root, #scrollDiv').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('.news_text .article')[0].cloneNode(true);
        (0, _jquery2.default)('#divBox, .mask_div, .gisa_banner, div[id^="AD_LIVE_AREA_"]', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.acle_c .a_day').text().split('|');
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var image = (0, _jquery2.default)('#DivContents .img_review_ad')[0];
        var content = (0, _jquery2.default)('#DivContents .review_text02')[0].cloneNode(true);
        if (image !== undefined) {
            content.insertBefore(image.cloneNode(true), content.firstChild);
        }
        (0, _jquery2.default)('.ad_gigigi', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#reView p').contents().eq(0).text().replace(/기사입력\s*:\s(\d{4})\.(\d{2})\.(\d{2}).*/, '$1/$2/$3')),
        lastModified: undefined
    };
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('iframe, #scrollDiv').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#articleBody')[0].cloneNode(true);
        (0, _jquery2.default)('table[width="320"][height="265"][align="right"], iframe', content).closest('table').remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var view_time = (0, _jquery2.default)('.View_Time')[0].cloneNode(true);
        (0, _jquery2.default)('span', view_time).remove();
        return {
            created: new Date((0, _jquery2.default)(view_time).text().trim().split(/\s+/).join(' ').replace(/\./g, '/')),
            lastModified: undefined
        };
    }();
    jews.reporters = function () {
        var view_info = (0, _jquery2.default)('.View_Info').text().split('|').reverse();
        return [{
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        (0, _jquery2.default)('.phototitle[style="display: none;"], .hidephotocaption, .photocaption[style="display: none;"], .daum_ddn_area, #body_relnews', content).remove();
        (0, _jquery2.default)('iframe[src^="/comm/ads"], iframe[id^=google_osd]', content).remove();
        content.innerHTML = content.innerHTML.split('<!-- //news_body -->')[0];
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.article_head .wr_day').text();
    ...
    jews.reporters = [{
        name: (0, _jquery2.default)('.writer_info > .fwb > a').text().trim(),
        mail: (0, _jquery2.default)('.article_body > .fl').text().trim()
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#fb-root, #scrollDiv').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        (0, _jquery2.default)('a[href="javascript:search_gija();"]', content).remove();
        (0, _jquery2.default)('[id^=div-gpt-ad]', content).parent().remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('#content .info').text().replace(/(\d+)[^\d]+(\d+)[^\d]+(\d+)[^\d]+(\d+):(\d+)/, '$1/$2/$3 $4:$5')),
        lastModified: undefined
    };
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv, #soeaFrame_, #soeaLayerLoc_st, #soeaLayerLoc_fi, iframe').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#news_content')[0].cloneNode(true);
        (0, _jquery2.default)('.adsbygoogle', content).remove();
        (0, _jquery2.default)('.slogan', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    function parseDate(t) {
        ...
        if (date !== null) return new Date(t.replace(/-/g, '/').replace(/[가-힣]/g, '').replace(/^\s+/g, ''));else {
            if (m === null) {
                if ((m = /(\d+)시간전/.exec(t)) !== null) d /= 24;else if ((m = /(\d+)분전/.exec(t)) !== null) d /= 24 * 60;
            }
            if (m !== null) return new Date(((Date.now() / d | 0) - (m[1] | 0)) * d - 1000 * 60 * 60 * 9 /* +09:00 */);
        }
    }
    jews.timestamp = {
        created: parseDate((0, _jquery2.default)('.news_dates')[0].childNodes[0].textContent.trim()),
        lastModified: parseDate((0, _jquery2.default)('.news_dates')[0].childNodes[2].textContent.trim())
    };
    jews.reporters = [{
        name: (0, _jquery2.default)('#news_sig strong').text(),
        mail: (0, _jquery2.default)('#news_sig').text().replace(/[가-힣()]/g, '').trim()
    }];
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('.article')[0].cloneNode(true);
        (0, _jquery2.default)('.stit, .banner-0-wrap, .article_ban, .adrs', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.article .adrs .pblsh').text().replace(/\s*송고/, '')),
        lastModified: undefined
    };
    jews.reporters = [];
    return jews;
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('.at_contents')[0].cloneNode(true);
        (0, _jquery2.default)('.atc_btn', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var lastModified = (0, _jquery2.default)('.newstitle .info_data div').eq(0).text().split(/최종 업데이트 |l/)[2];
        if (lastModified) lastModified = new Date('20' + lastModified.replace(/\./g, '/'));else lastModified = undefined;
        return {
            created: new Date('20' + (0, _jquery2.default)('.newstitle .info_data div')[0].childNodes[0].textContent.replace(/\./g, '/')),
            lastModified: lastModified
        };
    }();
    jews.reporters = [{
        name: (0, _jquery2.default)('.newstitle .info_data div a').eq(0).text(),
        mail: undefined
    }];
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        ...
        article.innerHTML = (0, _jquery2.default)('.articlePage')[0].innerHTML.split(/\s*<!--\s*article\s*[a-z]+\s*-->\s*/i)[1];
        ...
        return (0, _util.clearStyles)(article).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.articleHeadlineBox .dateStamp')[0].textContent.replace(/\s*KST\s*$/, ' +0900').replace(/(\d+)\.?\s+([a-z]{3})[a-z]+\s+(\d+)\s*,\s*/i, '$1 $2 $3 ')), /* RFC 2822 */
        lastModified: undefined
    };
    jews.reporters = function () {
        var byline = (0, _jquery2.default)('.socialByline .byline')[0];
        if (byline) {
            return [{
            ...
            return [{
                name: (0, _jquery2.default)('.socialByline .popTrigger').text(),
                mail: (0, _jquery2.default)('.socialByline .socialTools .email').text()
            }];
        }
    }();
    return jews;
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#viewcontent_inner')[0].cloneNode(true);
        var image = (0, _jquery2.default)('#imgReTouchLoc_1');
        if (image[0]) {
            image = image[0].cloneNode(true);
            (0, _jquery2.default)('.gal', image).remove();
        } else {
            image = false;
        }
        (0, _jquery2.default)('.stocksise', content).each(function (i, el) {
            (0, _jquery2.default)(el).replaceWith((0, _jquery2.default)('b', el).text());
        });
        return (image ? (0, _util.clearStyles)(image).innerHTML : '') + (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.newsdate').text().split(' | ');
        return {
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#article_content')[0].cloneNode(true);
        (0, _jquery2.default)('#spnAddLinkArticleContent, .ad_article_bottom1text', content).remove();
        var trimIndex = -1;
        (0, _jquery2.default)(content).contents().each(function (i, v) {
    ...
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.artical_date').contents();
        var lastModified;
        if (parsedData.length > 1) {
            lastModified = new Date(parsedData.eq(1).text().replace('수정 ', '').replace(/\./g, '/'));
        }
    ...
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('#gnb_banner, .article_ad250, iframe, div#fb-root').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('.article')[0].cloneNode(true);
        (0, _jquery2.default)('.promotion', content).remove();
        (0, _jquery2.default)('div[class*=date_]', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var timeStr = (0, _jquery2.default)('#date_text')[0].textContent;
        var created;
    ...
    jews.reporters = [{
        name: (0, _jquery2.default)('#j1').text().trim().split(' ')[0],
        mail: (0, _jquery2.default)('.j_con_li a').text() || undefined
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv').remove();
    };
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#news_body_id')[0].cloneNode(true);
        (0, _jquery2.default)('#date_text, #keyword, #rel_art_list_id, .copy_2011, script, iframe', content).remove();
    ...
    (0, _jquery2.default)('.news_title_author a').each(function () {
        jews.reporters.push({
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#articlebody')[0].cloneNode(true);
        (0, _jquery2.default)('#divArticleBottomTextBannerInline, .article_middle_ad', content).remove();
        (0, _jquery2.default)('table', content).each(function (i, v) {
            v.removeAttribute('width');
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.date').text()),
        lastModified: undefined
    };
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('iframe, #gnb_banner, .article_ad250').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('#article_body')[0].cloneNode(true);
        (0, _jquery2.default)('[style="display:none;"]', content).remove();
        (0, _jquery2.default)('#__inline_ms_da_ad__', content).remove();
        (0, _jquery2.default)('#relation_news', content).remove();
        (0, _jquery2.default)('span', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var text = (0, _jquery2.default)('.article_head .byline').text();
    ...
    jews.reporters = function () {
        var reporters = (0, _jquery2.default)('.layer_journalist_wrap');
        var list = [];

        reporters.each(function (el) {
            var name = (0, _jquery2.default)('.layer_journalist_area .mg a', el).text().trim().match(/(.*?) 기자/)[1];
            var mail,
                mail_el = (0, _jquery2.default)('.share_area a', el);
    ...
    jews.cleanup = function () {
        (0, _jquery2.default)('body>iframe, #gnb_banner, #criteo_network').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)('.m_container .sub_view_cont')[0].cloneNode(true);
        (0, _jquery2.default)('.view_ad', content).remove();
        (0, _jquery2.default)('[align]', content).each(function (v) {
            v.removeAttribute('align');
        });
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var created = (0, _jquery2.default)('.m_container .sub_view_tit3 .tit3_2 span').text().replace('입력 : ', '').replace(/\./g, '/');
        var lastModified = (0, _jquery2.default)('.m_container .sub_view_tit3 .tit3_3 span').text().replace('수정 : ', '').replace(/\./g, '/');
        var timeIndex;
    ...
    jews.reporters = function () {
        var name = (0, _jquery2.default)('.m_container .sub_view_tit3 .tit3_1 span').text();
        var mail = (0, _jquery2.default)('.journalist_1 span a').text().trim() || undefined;
        return [{
            name: name,
            mail: mail
        }];
...
exports.default = function () {
    ...
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('iframe, [id^=goog], [id^=popIn_menu]').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)('#p')[0].cloneNode(true);
        (0, _jquery2.default)('#webtalks_btn_listenDiv', content).remove();
        return (0, _util.clearStyles)(content).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.view_page_news .view_page_news_header_wrapper span');
        var nbsp = '\xA0';
        return {
    ...
    jews.reporters = function () {
        var mail = (0, _jquery2.default)('.view_page_translation_email a').attr('href');
        if (mail) {
            return [{
                name: undefined,
...
exports.default = function () {
    ...
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.nview .writedata .date').contents();
        return {
...
exports.default = function () {
    ...
    jews.content = function () {
        var content = (0, _jquery2.default)((0, _jquery2.default)('#article_body')[0].cloneNode(true));
        (0, _jquery2.default)('#ad_body', content).remove();
        return (0, _util.clearStyles)(content[0]).innerHTML;
    }();
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.sub_news_data .news_data .list_02').text().split('|');
        return {
    ...
    jews.reporters = [{
        name: (0, _jquery2.default)('.sub_news_data .news_data .list_01 a').eq(0).text().trim(),
        mail: (0, _jquery2.default)('.sub_news_data .news_data .list_01 .reporter_layer dd span a').text() || undefined
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv').remove();
    };
...
exports.default = function () {
    ...
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.hboxbylinedata span').text().trim().replace(/\./g, '-').replace(/\s+/, 'T') + '+09:00'),
        lastModified: undefined
    };
    jews.reporters = [{
        name: (0, _jquery2.default)('.hboxbylinedata a').text(),
        mail: undefined
    }];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv').remove();
...
exports.default = function () {
    ...
    jews.content = (0, _util.clearStyles)(content[0]).innerHTML;
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.atc-info').children();
    ...
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('#scrollDiv, iframe').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    (0, _jquery2.default)('div>iframe', content).remove();
    (0, _jquery2.default)('.tt-wrapper', content).remove();
    jews.content = (0, _util.clearStyles)(content[0]).innerHTML;
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.writeDate').text().replace('입력 : ', '').replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = function () {
        var parsedData = (0, _jquery2.default)('.journalist_mail').contents();
...
exports.default = function () {
    ...
    jews.content = (0, _util.clearStyles)(content[0]).innerHTML;
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.news_info').children();
        function parseDate(s) {
            return new Date(s.replace(/-/g, '/').replace(/[가-힣]/g, '').replace(/^\s+/g, ''));
        }
        return {
...
exports.default = function () {
    ...
    (0, _jquery2.default)('.article-ad-align-left', content).remove();
    jews.content = (0, _util.clearStyles)(content[0]).innerHTML;
    jews.timestamp = function () {
        var parsedData = (0, _jquery2.default)('.newsStoryDetail .author .writeOption p').contents();
        var created = parsedData[0] || undefined;
        var lastModified = parsedData[2] || undefined;
        if (created) {
    ...
    jews.reporters = function () {
        var name = (0, _jquery2.default)('.newsStoryDetail .author .authorInfo').text().trim().split(/\s+/).join(' ') || undefined;
        var mail = (0, _jquery2.default)('.newsStoryDetail .author .authorLink a[href^="mailto:"]');
        if (mail) {
            return [{
                name: name,
...
exports.default = function () {
    ...
    var mainVideoContent = function () {
        var $mainVideo = (0, _jquery2.default)('.main-visual iframe');
        if ($mainVideo.length) {
    ...
    jews.title = (0, _jquery2.default)('h1.title').text();
    jews.subtitle = undefined;
    jews.content = function () {
        var content = (0, _jquery2.default)((0, _jquery2.default)('#mainentrycontent')[0].cloneNode(true));
        (0, _jquery2.default)('.float_left', content).remove();
        return mainImageContent + mainVideoContent + (0, _util.clearStyles)(content[0]).innerHTML;
    }();
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.posted time[datetime]').attr('datetime')),
        lastModified: new Date((0, _jquery2.default)('.updated time[datetime]').attr('datetime'))
    };
    jews.reporters = function () {
    ...
    jews.cleanup = function () {
        var $share = (0, _jquery2.default)('a[href*="mailto"]');
        if ($share.length) {
            (0, _jquery2.default)($share[0].parentNode).remove();
        }
        (0, _jquery2.default)('.pinitshareimage').remove();
        (0, _jquery2.default)('.ad_wrapper').remove();
        (0, _jquery2.default)('.hp-slideshow-wrapper').remove();
    };
    return jews;
};
...
exports.default = function () {
    ...
    (0, _jquery2.default)('span[style="width:640px; height:70px; text-align:center; margin:0 10px; padding:10px 10px 15px 10px; clear:both;"]', $content).remove();
    jews.title = (0, _jquery2.default)('.article_text span').text();
    jews.subtitle = undefined;
    jews.content = (0, _util.clearStyles)($content[0]).innerHTML;
    jews.timestamp = {
        created: new Date((0, _jquery2.default)('.new_time').text().replace('기사입력', '').replace(/-/g, '/')),
        lastModified: undefined
    };
    jews.reporters = [];
    jews.cleanup = function () {
        (0, _jquery2.default)('div[id^=soea], #wp_adbn_root, #mobon_toast_banner').remove();
        (0, _jquery2.default)('#scrollDiv').remove();
        (0, _jquery2.default)('#tbFadeIn').remove();
    };
    return jews;
};
...
FuseBox.import("default/jews.user.js");
FuseBox.main("default/jews.user.js");
})
